...
Note that Java 8’s _default_ methods are not _abstract_ ([[Abstraction]]) and do not count - a functional interface may still have multiple _default_ methods ([[Default Methods in Interfaces]]).
