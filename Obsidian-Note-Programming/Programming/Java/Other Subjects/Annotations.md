...
class MyClass { ... }
```
If the _annotations_ have the same type, then this is called a [[Repeating Annotations]].
```java
@Author(name = "Jane Doe")
...
As of the Java SE 8 release, _annotations_ can also be applied to the use of types ([[Type Use Annotations]]). Here are some examples:
