# 1. <ins>Java Development Process</ins>

## 1.1. _JCP_ - <ins>Java Community Process</ins>
...
## 1.2. _JSR_ - <ins>Java Specification Request</ins>
...
## 1.3. _JEP_ - <ins>Java Enhancement Proposal</ins>
...
## 1.4. _JLS_ - <ins>Java Language Specification</ins>
...
# **References:**
1. [Proces Rozwoju Javy](https://javastart.pl/baza-wiedzy/slownik/proces-rozwoju-javy)
2. [What is difference between jls jsr and jep](https://stackoverflow.com/questions/51282326/what-is-the-difference-or-relation-between-jls-jsr-and-jep)