...
Functional interfaces, which are gathered in the [java.util.function APIs](../platform-roadmap/java-se-8-lts/api/002_java-util-function-apis.md) package, satisfy most developers’ needs in providing target types for lambda expressions and method references. Each of these interfaces is general and abstract, making them easy to adapt to almost any lambda expression. Developers should explore this package before creating new functional interfaces.
