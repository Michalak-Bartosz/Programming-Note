...
1. [Lambda Expressions](../platform-roadmap/java-se-8-lts/language/003_lambda-expressions.md)
2. [Type Inference](../language-mastery/018_type-inference.md)
3. [Effectively Final Variables](../platform-roadmap/java-se-8-lts/language/002_effectively-final-variables.md)

# 3. Tips:

## 3.1. Don’t Treat Lambda Expressions as Inner Classes
...
## 3.2. Keep Lambda Expressions Short and Self-explanatory
...
### 3.2.1. Avoid Blocks of Code in Lambda’s Body
...
### 3.2.2. Avoid Specifying Parameter Types

A compiler, in most cases, is able to resolve the type of lambda parameters with the help of [Type Inference](../language-mastery/018_type-inference.md). Consequently, adding a type to the parameters is optional and can be omitted.
...
### 3.2.3. Avoid Parentheses Around a Single Parameter
...
### 3.2.4 Avoid Return Statement and Braces
...
## 3.3. Use "Effectively Final" Variables
...
According to the [Effectively Final Variables](../platform-roadmap/java-se-8-lts/language/002_effectively-final-variables.md) concept, a compiler treats every variable as _final_ as long as it is assigned only once.
...
### 3.4. Protect Object Variables From Mutation
