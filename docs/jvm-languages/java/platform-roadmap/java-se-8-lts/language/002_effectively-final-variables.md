...
Generally, it's not a good practice to modify variables used in lambda expressions and [Anonymous Classes](../../../language-mastery/002_anonymous-classes.md). We cannot know how these variables are going to be used inside method blocks. Mutating them might lead to unexpected results in multithreading environments.
