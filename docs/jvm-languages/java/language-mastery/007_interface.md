...
```
All method declarations in an interface, including default methods, are implicitly public, so you can omit the public modifier. We see the interface has a default method. This feature was provided in Java SE 8 LTS version (More info: [Default Methods in Interfaces](../platform-roadmap/java-se-8-lts/language/001_default-methods-in-interfaces.md)).
...
* static methods
* default methods ([Default Methods in Interfaces](../platform-roadmap/java-se-8-lts/language/001_default-methods-in-interfaces.md))
