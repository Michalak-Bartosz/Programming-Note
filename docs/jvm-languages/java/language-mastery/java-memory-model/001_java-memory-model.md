...
![1.Java memory model basic structure.png](001_java-memory-model-basic-structure.png)
...
![2.Head divided.png](002_head-divided.png)
...
![3.Tunning Heap.png](003_tuning-heap.png)

---
## 1.4. Monitor Java Memory
...
---
# References:
1. [Medium - Java memory model](https://medium.com/@alxkm/java-memory-model-3b973e84dc8c){ target="_blank" rel="noopener noreferrer" }
