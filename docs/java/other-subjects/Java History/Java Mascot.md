# 1. <ins>Java mascot</ins>

Official Java mascot is [JavaDuke.png](javaduke.png.md):

![img.png](Images/JavaDuke.png)
[JavaDuke.png](javaduke.png.md)
...
# **References:**
1. https://en.wikipedia.org/wiki/File:Duke_(Java_mascot)_waving.svg
2. https://dev.java/duke/
