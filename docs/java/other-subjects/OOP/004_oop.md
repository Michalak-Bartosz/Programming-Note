...
The first step in _OOP_ is to collect all of the objects a programmer wants to manipulate and identify how they relate to each other -- an exercise known as [Data Modeling](../004_data-modeling.md).
...
# **References:**
1. [TechTarget - Object-Oriented Programming](https://www.techtarget.com/searchapparchitecture/definition/object-oriented-programming-OOP){ target="_blank" rel="noopener noreferrer" }
