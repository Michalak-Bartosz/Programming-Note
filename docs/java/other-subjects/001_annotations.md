...
class MyClass { ... }
```
If the _annotations_ have the same type, then this is called a [Repeating Annotations](../jdk/java-se-8-lts/features/language/004_repeating-annotations.md).
```java
@Author(name = "Jane Doe")
...
As of the Java SE 8 release, _annotations_ can also be applied to the use of types ([Type Use Annotations](../jdk/java-se-8-lts/features/language/005_type-use-annotations.md)). Here are some examples:
...
[Repeating Annotations](../jdk/java-se-8-lts/features/language/004_repeating-annotations.md)
