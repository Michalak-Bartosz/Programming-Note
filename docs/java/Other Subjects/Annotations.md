...
## 1.1. <ins>The Format of an Annotation</ins>
...
class MyClass { ... }
```
If the _annotations_ have the same type, then this is called a [Repeating Annotations](repeating-annotations.md).
```java
@Author(name = "Jane Doe")
...
## 1.2. <ins>Where Annotations Can Be Used</ins>
...
As of the Java SE 8 release, _annotations_ can also be applied to the use of types ([Type Use Annotations](type-use-annotations.md)). Here are some examples:
...
[Repeating Annotations](repeating-annotations.md)
