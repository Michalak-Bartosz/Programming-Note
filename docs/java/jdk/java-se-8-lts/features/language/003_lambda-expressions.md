...
## 1.1. <ins>Internal & External Iteration:</ins>
...
## 1.2. <ins>Streams and lambdas:</ins>
Lambda Expressions are common used with [Stream API](stream-api.md).
# 2. <ins>More about:</ins>
1. [Lambda Expressions - Tips and Best Practices](lambda-expressions---tips-and-best-practices.md)
# **References:**
...
3. [State of the Lambda: Libraries Edition](https://cr.openjdk.org/~briangoetz/lambda/lambda-libraries-final.html)
