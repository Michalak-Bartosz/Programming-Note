...
1. [Lambda Expressions](../jdk/java-se-8-lts/features/language/003_lambda-expressions.md)
2. [Type Inference](../other-subjects/018_type-inference.md)
3. [Effectively Final Variables](../jdk/java-se-8-lts/features/language/002_effectively-final-variables.md)
...
A compiler, in most cases, is able to resolve the type of lambda parameters with the help of [Type Inference](../other-subjects/018_type-inference.md). Consequently, adding a type to the parameters is optional and can be omitted.
...
According to the [Effectively Final Variables](../jdk/java-se-8-lts/features/language/002_effectively-final-variables.md) concept, a compiler treats every variable as _final_ as long as it is assigned only once.
